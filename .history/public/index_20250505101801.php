...
$app->add(function ($request, $handler) {
    ...
    if ($apiKey !== $_ENV['API_TOKEN']) {
        return (new \Slim\Psr7\Response())->withStatus(401)->withHeader('Content-Type', 'application/json')->withBody(
            (new \Slim\Psr7\Factory\StreamFactory())->createStream(json_encode(['error' => 'Unauthorized']))
        );
    }
