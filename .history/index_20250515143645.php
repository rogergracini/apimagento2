...
$app->post('/teste-fixo', function ($request, $response) {
    file_put_contents(__DIR__ . '/logs/debug.log', "rota /teste-fixo chamada\n", FILE_APPEND);
    $response->getBody()->write(json_encode(['rota' => 'ok']));
    return $response->withHeader('Content-Type', 'application/json');
});
